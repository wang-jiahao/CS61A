...
from libs.flask_package.flask import render_template
...
class Ant(Insect):
    ...
    def double(self):
        ...
        while place:
            ant = place.ant
            if ant and not ant.is_doubled:
                ant.is_doubled = True
                ant.damage *= 2
            if ant and ant.is_container and ant.ant_contained and not ant.ant_contained.is_doubled:
